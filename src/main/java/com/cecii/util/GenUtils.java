...
import com.cecii.common.CommonMap;
...
public class GenUtils
{
    ...
    public static VelocityContext getVelocityContext(TableInfo table)
    {
        ...
        velocityContext.put("pkNum", table.getPkNum());
...
//        }
        ...
        {
            return javaPath + "/dao/"+className+"Mapper.xml";
        }
     ...
     * @return
     */
	public static List<ColumnInfo> getPrimaryKey(List<ColumnInfo> columns) {
		List<ColumnInfo> pkList = new ArrayList<>();
		columns.forEach(action->{
			if("PRI".equals(action.getColumnKey())) {
				pkList.add(action);
			}
		});
		return pkList;
